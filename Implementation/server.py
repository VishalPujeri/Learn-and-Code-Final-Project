...
def handle_admin_commands(admin, command, params, menu):
    ...
    if command == 'register_user':
        ...
        admin.update_menu_item(item_name, item_new_name, float(price), int(availability))
        ...
        item_name = params[0]
        admin.delete_menu_item(item_name)
...
def handle_employee_commands(employee, command, params, menu):
    ...
    if command == 'provide_feedback':
        ...
        employee.provide_feedback(int(item_id), comment, float(rating))
